      ...
      <section className="bg-navy py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            School communities are the most trusted, highest-engagement environments for family-focused brands. BowTie gets you in through a vetted network of schools — authentically, at scale.
          </p>
        </div>
      </section>
